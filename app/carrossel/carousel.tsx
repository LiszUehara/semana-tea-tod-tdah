...
return (
  <div
    id="speakers"
    className="w-full h-screen bg-[#F5D1A5] bg-[url('/images/bg-site_02.jpg')] bg-cover bg-center bg-no-repeat flex flex-col items-center justify-center relative overflow-hidden px-40 "
  >

      <h2 className="text-orange-500 text-4xl font-bold mb-8 font-arsenica">PALESTRANTES</h2>
